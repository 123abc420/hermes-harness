...
import { useGithubSync } from '@/hooks/use-harness-data';
...
/* ── Commit History ──────────────────────────────────── */
export function CommitHistory({ githubStatus }: { githubStatus?: GithubStatus }) {
  const status = githubStatus;
...
/* ── Export Modules ───────────────────────────────────── */
export function ExportModules({ modules }: { modules?: ExportModule[] }) {
  const list = modules ?? [];
