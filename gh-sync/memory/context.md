...
## Last Updated
2026-06-20 04:50 UTC+8

## System Status
- **Phase**: Post-Compliance Evolution (Wave 72)
- **Waves in DB**: 66
...
- Research tab: memory (extracted), skills (extracted), category pie, outcome donut, wave category breakdown, decision timeline
- Extracted components: MemorySection, SkillsSection, WaveCategoryBreakdown, ErrorBlock
- Dashboard API returns 50 recent decisions (was 20)
...
3. Decision timeline expand/collapse to show reasoning